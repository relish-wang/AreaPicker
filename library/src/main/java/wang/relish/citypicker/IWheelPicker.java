...
public interface IWheelPicker {
     ...
     * series of data, and with the position 3 as a new starting point of WheelPicker, this behavior
     ...
     * @return 数据列表
     */
    List<? extends IPickerModel> getData();
     ...
     * @param data 数据列表
     */
    void setData(List<? extends IPickerModel> data);
